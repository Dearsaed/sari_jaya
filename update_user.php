...
$query    = "SELECT id_user,username,fullname,level,password,alamat,telp FROM USER WHERE ID_USER='$update_id'";
            ...
            <div class="row">
              ...
              $alamat=$r[5];
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="alamat" class="form-control col-md-7 col-xs-12" type="alamat" name="alamat" required value="<?php echo $alamat ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="telp" class="control-label col-md-3 col-sm-3 col-xs-12">NO. TELP<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="telp" class="form-control col-md-7 col-xs-12" type="telp" name="telp" required value="<?php echo $telp ?>">
                        </div>
                      </div>
