...
$query = "SELECT id_user,username,fullname,level,alamat,telp FROM user where username != '$user_check'";
$query2 = "SELECT id_user,username,fullname,level,alamat,telp FROM user where username = '$user_check'";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> DATA USER <small>Data User Sari Jaya</small></h3>
              </div>
            </div>
