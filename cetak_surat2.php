...
$query    = "SELECT id_surat_keluar, id_jenis, pengirim, tujuan,tanggal_surat, perihal, deskripsi, tanggal_entri, staff, laporan FROM surat_keluar where id_surat_keluar = '$update_id'";;
