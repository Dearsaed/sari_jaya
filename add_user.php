                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="proses_user.php">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="alamat" class="form-control col-md-7 col-xs-12" type="alamat" name="alamat" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="telp" class="control-label col-md-3 col-sm-3 col-xs-12">NO. TElp<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="telp" class="form-control col-md-7 col-xs-12" type="telp" name="telp" required>
                        </div>
                      </div>
