...
$query = "SELECT id_surat_keluar,jenis,pengirim,tujuan,tanggal_surat,perihal,deskripsi,nama_file,tanggal_entri, staff, laporan FROM surat_keluar, jenis WHERE jenis.id_jenis = surat_keluar.id_jenis and staff = '$user_check'";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> SURAT KELUAR <small> STAFF </small></h3>
              </div>
