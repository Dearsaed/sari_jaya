                  ...
                  <div class="x_content">
                           ...
                           if($id_mobil==all)
                           {
                            ...
                            $sql12 = mysqli_query ($conn,$query12);
                             ...
                             $label=$tahun." Total Semua Mobil Sebabnya ".$sebab;
                           }
// ---------------------------------------------------------------------------------------------------------------------------------------------
// ---------------------------------------------------------------------------------------------------------------------------------------------
// ---------------------------------------------------------------------------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------------------------------------------------------------------------
                             ...
                             $query1 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='1' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql1 = mysqli_query ($conn,$query1);
                              while($r1=mysqli_fetch_array($sql1))
                              {
                                $nominal1=$r1['0']+$r1['1'];
                             ...
                             $query2 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='2' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql2 = mysqli_query ($conn,$query2);
                              while($r2=mysqli_fetch_array($sql2))
                              {
                                $nominal2=$r2['0']+$r2['1'];
                             ...
                             $query3 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='3' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql3 = mysqli_query ($conn,$query3);
                              while($r3=mysqli_fetch_array($sql3))
                              {
                                $nominal3=$r3['0']+$r3['1'];
                             ...
                             $query4 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='4' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql4 = mysqli_query ($conn,$query4);
                              while($r4=mysqli_fetch_array($sql4))
                              {
                                $nominal4=$r4['0']+$r4['1'];
                             ...
                             $query5 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='5' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql5 = mysqli_query ($conn,$query5);
                              while($r5=mysqli_fetch_array($sql5))
                              {
                                $nominal5=$r5['0']+$r5['1'];
                             ...
                             $query6 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='6' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql6 = mysqli_query ($conn,$query6);
                              while($r6=mysqli_fetch_array($sql6))
                              {
                                $nominal6=$r6['0']+$r6['1'];
                             ...
                             $query7 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='7' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql7 = mysqli_query ($conn,$query7);
                              while($r7=mysqli_fetch_array($sql7))
                              {
                                $nominal7=$r7['0']+$r7['1'];
                             ...
                             $query8 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='8' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql8 = mysqli_query ($conn,$query8);
                              while($r8=mysqli_fetch_array($sql8))
                              {
                                $nominal8=$r8['0']+$r8['1'];
                             ...
                             $query9 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='9' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql9 = mysqli_query ($conn,$query9);
                              while($r9=mysqli_fetch_array($sql9))
                              {
                                $nominal9=$r9['0']+$r9['1'];
                             ...
                             $query10 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='10' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql10 = mysqli_query ($conn,$query10);
                              while($r10=mysqli_fetch_array($sql10))
                              {
                                $nominal10=$r10['0']+$r10['1'];
                             ...
                             $query11 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='11' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql11 = mysqli_query ($conn,$query11);
                              while($r11=mysqli_fetch_array($sql11))
                              {
                                $nominal11=$r11['0']+$r11['1'];
                             ...
                             $query12 = "SELECT nominal FROM pengeluaran where MONTH(tgl)='12' AND YEAR(tgl)= '$tahun' AND id_sebab='$id_sebab' AND id_mobil='$id_mobil'";
                             $sql12 = mysqli_query ($conn,$query12);
                              while($r12=mysqli_fetch_array($sql12))
                              {
                                $nominal12=$r12['0']+$r12['1'];
